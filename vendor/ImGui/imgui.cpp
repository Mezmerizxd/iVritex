...
ImGuiIO::ImGuiIO()
{
    ...
    IniSavingRate = 5.0f;
    std::ostringstream imgui_Ini;
    std::ostringstream imgui_Log;
    imgui_Ini << std::getenv("appdata") << "\\iVritex\\ImGui\\imgui.ini";
    imgui_Log << std::getenv("appdata") << "\\iVritex\\ImGui\\imgui_log.txt";
    IniFilename = imgui_Ini.str().c_str();
    LogFilename = imgui_Log.str().c_str();
